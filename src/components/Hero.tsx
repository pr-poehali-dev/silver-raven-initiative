  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Гармония тела
          <span className="block text-sage">и разума</span>
        </h1>
        ...
        >
          Практики йоги и медитации для всех уровней подготовки. Создаём пространство для осознанности, здоровья и внутреннего спокойствия.
        </p>
